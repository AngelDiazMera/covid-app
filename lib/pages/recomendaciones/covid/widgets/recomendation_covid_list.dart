...
class RecommendationsCovidList extends StatefulWidget {
  final String title;
  final String recomendation;
  final String asset;

  RecommendationsCovidList(
      {Key key, this.title, this.recomendation, this.asset})
      : super(key: key);
  @override
  _RecommendationsCovidList createState() => _RecommendationsCovidList();
}

class _RecommendationsCovidList extends State<RecommendationsCovidList> {
  @override
